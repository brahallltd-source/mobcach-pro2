...
import { DangerButton, GlassCard, LoadingCard, PageHeader, PrimaryButton, StatCard } from "@/components/ui";
...
export function AgentWithdrawalsBoard() {
  ...
  if (loading) return <LoadingCard text="Loading withdrawals..." />;
